...
import { SubNavItem } from "../../root/components/navigation/field-types";

const fcLogger = getLogger("FC.SettingsRootPage", null, null, "DISABLED");

export const TAB_HEADS: SubNavItem[] = [
...
export const SettingsRootPage: FunctionComponent = () => {
  ...
  return (
    <section className="settings-section">
      {deviceMode === DeviceMode.Desktop && <SettingsRootHeroTabs />}
      {deviceMode === DeviceMode.Mobile && <Outlet />}
    </section>
  );
};

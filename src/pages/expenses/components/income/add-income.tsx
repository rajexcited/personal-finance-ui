...
export const AddIncome: FunctionComponent = () => {
  ...
  useEffect(() => {
    ...
    useEffectLogger.debug("navigation state:", navigation.state, "; navigation location:", navigation.location, "; shortPath: ", getShortPath("addIncome"));
    if (navigation.state === "submitting") {
      setSubmitLabel("Adding...");
    } else if (navigation.state === "loading" && !navigation.location?.pathname.endsWith(getShortPath("addIncome"))) {
    ...
    <>
      {errorMessage && (
        <Animated
          ...
          {...testAttributes("add-income-error-message")}
        >

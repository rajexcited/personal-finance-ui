...
import { TagsInput, Calendar, DropDown, Input, TextArea, DropDownItemType, TagObject, TagsInputSharePerson, CurrencySymbol } from "../../../../components";
...
export const IncomeForm: FunctionComponent<IncomeFormProps> = (props) => {
  ...
  useEffect(() => {
    ...
    logger.debug(
      ...
      props.paymentAccounts,
      ", props.incomeDetails?.paymentAccountId =",
      props.incomeDetails?.paymentAccountId,
      ", props.incomeDetails?.paymentAccountName =",
      props.incomeDetails?.paymentAccountName
    );
    ...
    <form onSubmit={onSubmitHandler}>
      <div className="columns">
        <div className="column">
          ...
          <div className="columns">
            <div className="column">
              <TextArea id="income-desc" label="Description: " rows={2} value={description} onChange={setDescription} key={"income-desc"} maxlength={150} />
            </div>
          </div>
          <div className="columns">
            <div className="column">
            ...
            <div className="column">
              <div className="my-1 py-1">
                <Calendar
                  ...
                  onSelect={(range) => {
                    setIncomeDate((prev) => range.start || prev);
                  }}
                />
              </div>
            </div>
      ...
      <div className="columns footer-form-actions is-display-mobile">
        <div className="column">
          <div className="buttons">
            <button className="button is-dark is-large is-fullwidth" type="submit" {...testAttributes("submit-income")}>
      ...
      <div className="columns footer-form-actions is-hidden-mobile">
        ...
        <div className="column">
          <div className="buttons is-centered">
            <button className="button is-dark is-large" type="submit" {...testAttributes("submit-income")}>
              <span className="px-2-label">{props.submitLabel}</span>
            </button>
          </div>
        </div>
